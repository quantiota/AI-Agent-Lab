...
- Connect to the remote JupyterHub environment from within the Code-Server interface provided by the AI Agent Lab with `/opt/venv/bin/jh-exec run your-script.py` 
